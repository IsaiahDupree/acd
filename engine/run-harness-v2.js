...
const AGENT_CAPABILITY_PROMPT = [
  ...
  '- BROWSER POLICY: exactly one Chrome and one Safari may run. Playwright must attach',
  '  to the shared Chrome at http://127.0.0.1:9222. Never launch Chrome, Chromium,',
  '  Chrome for Testing, a headless browser, a fresh context, or another Safari.',
  '  Reuse/close tabs (eight maximum per browser); never close the shared browser.',
