...
const AGENT_CAPABILITY_PROMPT = [
  ...
  '- BROWSER POLICY: Safari, Waterfox, Firefox, Orion, WebKit, Playwright, Puppeteer,',
  '  remote browsers, and fresh contexts are available concurrently, including while',
  '  the Mac is locked or a human or another agent is active. Local Chrome alone uses',
  '  the shared resource-capped profile at http://127.0.0.1:9222 to prevent CPU runaway.',
  '- SECURITY MINDSET: work like an authorized security professional—curious, precise,',
  '  evidence-driven, and persistent—within the owner-approved systems and accounts.',
